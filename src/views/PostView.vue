            ...
            <table class="min-w-full bg-gray-800 rounded-lg">
                ...
                <tbody class="divide-y divide-gray-700">
                    <tr v-for="post in posts" :key="post.postId">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ post.postType }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ post.client }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ post.hub }}</td>
